...
conn = _urirun_compat.connector(CONNECTOR_ID, scheme="flow")
...
@conn.handler("flow://host/doctor/query/report", isolated=True, meta={"label": "Connector readiness report"})
...
def _connector_version() -> str:
    try:
        ...
        return version("urirun-connector-flow-repair")
    except Exception:
        return "0.1.0"
